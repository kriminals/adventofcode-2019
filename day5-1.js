...
console.log(idx, curArr, instruction.opCode);
  ...
  switch (instruction.opCode) {
    ...
    case 4:
      ...
      break;
    case 5:
      if (instruction.b == 0 && instruction.c == 0 && input[input[idx + 1]] != 0) {
      ...
      if (instruction.b == 1 && instruction.c == 0 && input[input[idx + 1]] != 0) {
        idx = input[idx + 2] -1;
        break;
      }
    ...
    case 6:
      ...
      break;
    case 7:
      if (instruction.b == 0 && instruction.c == 0 && input[input[idx + 1]] < input[input[idx + 2]]) {
        input[input[idx + 3]] = 1;
        idx += 3;
        break;
        // done till here
      } else if (instruction.b == 0 && instruction.c == 1 && input[idx + 1] < input[input[idx + 2]]) {
        input[input[idx + 3]] = 1;
        idx += 3;
        break;
      } else if (instruction.b == 1 && instruction.c == 0 && input[input[idx + 1]] < input[idx + 2]) {
        input[input[idx + 3]] = 1;
        idx += 3;
        break;
      } else if (instruction.b == 1 && instruction.c == 1 && input[idx + 1] < input[idx + 2]) {
        input[input[idx + 3]] = 1;
        idx += 3;
        break;
      } else {
